          ...
          <div class="form-area p-3 bg-white " style="overflow-y: auto;">
            ...
            <form class="addInvoice" id="myForm">
              ...
              <div class="invoice_form w-100 ms-1 row bg-white mt-3 px-3">
                ...
                <div class="col-4 mt-4" style="position: relative;">Client Name <sup class="text-danger">*</sup>:<input type="text" maxlength="25" id='automplete-1' onchange="fetchClientData()" class="client-name-invoice form-control bg-white " placeholder="Client Name">
                ...
                <table class="w-100 itemTable table mt-5">

                </table>
                <div class="col-3 pt-3"><button type="button" class="btn btn-outline-primary" onclick="addMore()">Add More</button></div>
